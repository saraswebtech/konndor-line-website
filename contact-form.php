<?php
    ...
    // Instantiation and passing [ICODE]true[/ICODE] enables exceptions
        ...
        //Recipients
        $mail->setFrom('mail@saraswebtech.in', 'konnder line Contact Form');
        $mail->addAddress('saraswebtech@gmail.com', 'konnder'); // Add a recipient
    	...
    	if(!$mail->send()) {
    	    ...
    	    echo 'Mailer Error: ' . $mail->ErrorInfo;
                ...
                echo "setTimeout(function(){ window.location.href = 'contact-konndor-line.html'; }, 3000);";  // Redirect after 3 seconds
                echo "</script>";
    	}
    ?>